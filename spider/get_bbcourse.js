...
var req = unirest("POST", "https://c.zju.edu.cn/webapps/streamViewer/streamViewer");
...
req.end(function (res) {
    ...
    data.map((item) => {
        noticeList.push({
            ...
            firstName: item.itemSpecificData.notificationDetails.announcementFirstName,
            lastName: item.itemSpecificData.notificationDetails.announcementLastName,
            body: item.itemSpecificData.notificationDetails.announcementBody
        })
    })
